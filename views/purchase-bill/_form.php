        ...
        <tbody id="list-products">
            <?php foreach ($model->purchases as  $purchase) : ?>
                <tr id="row<?= $purchase->PNo ?>">
                    ...
                    <td><?= $form_mode == "view" ? null : Html::a('ลบ', null, $options = ['class' => 'btn btn-danger', 'onclick' => '$("#row' . $purchase->PNo . '").remove()']) ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
        ...
        <tbody>
            ...
            <table class="d-none">
                <tr id="template">
                    ...
                    <td>%prodQty%</td>
                    <td>%price%</td>
                    <td><?= Html::a('ลบ', null, $options = ['class' => 'btn btn-danger', 'onclick' => "$('#row%i%').remove()"]) ?></td>
                </tr>
            </table>
