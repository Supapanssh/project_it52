...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 15, 2021 at 02:01 PM
...
CREATE TABLE `bill` (
  `BillNo` int(11) NOT NULL COMMENT 'รหัสใบเสร็จ',
...
(24, '2021-01-14 23:15:11', 1, NULL, 0, '1167.37', '1167.37', '76.37', 0),
(25, '2021-02-14 23:52:55', 1, NULL, 0, '2953.20', '2953.20', '193.20', 0);
...
CREATE TABLE `bill_detail` (
  ...
  `pno` int(11) NOT NULL COMMENT 'รหัสสินค้า',
  `amount` double NOT NULL COMMENT 'ราคารวม',
  `bill_id` int(11) DEFAULT NULL COMMENT 'รหัสบิล'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `bill_detail` (`id`, `quantity`, `pno`, `amount`, `bill_id`) VALUES
(45, 3, 12, 597, 24),
(46, 1, 29, 295, 24),
(47, 1, 4, 199, 24),
(48, 4, 1, 2760, 25);
...
CREATE TABLE `cart` (
  `id` int(11) NOT NULL COMMENT 'ไอดีตะกร้าสินค้า',
  `quantity` int(11) NOT NULL COMMENT 'จำนวน',
  `PNo` int(11) DEFAULT NULL COMMENT 'รหัสสินค้า',
  `userNo` int(11) DEFAULT NULL COMMENT 'รหัสผู้ใช้งาน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `category` (
  `category_id` int(11) NOT NULL COMMENT 'รหัสหมวดหมู่สินค้า',
  `category_name` varchar(250) DEFAULT NULL COMMENT 'ชื่อหมวดหมู่',
  `category_desc` varchar(250) NOT NULL COMMENT 'รายละเอียดหมวดหมู่'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(19, 'คอมแอร์', ''),
(20, 'สายพาน', ''),
(21, 'ชุดสายพานไทม์มิ่ง', ''),
(22, 'คอยล์หน้าคลัช', ''),
(23, 'ฝาครอบฟิลเตอร์แอร์', ''),
(24, 'แผงแอร์', ''),
(25, 'ผ้าเบรคหลัง', ''),
(26, 'หวีคลัช', ''),
(27, 'จานคลัช', ''),
...
CREATE TABLE `employee` (
  `ID` int(10) NOT NULL COMMENT 'คีย์',
  `Emp_ID` varchar(5) NOT NULL COMMENT 'รหัสพนักงาน',
  `Emp_idcard` int(15) NOT NULL COMMENT 'เลขบัตรประชาชน',
  `Emp_name` varchar(50) NOT NULL COMMENT 'ชื่อ',
  `Emp_lname` varchar(10) NOT NULL COMMENT 'นามสกุล',
  `Emp_sex` varchar(5) NOT NULL COMMENT 'เพศ',
  `Emp_birth` date NOT NULL COMMENT 'วันเกิด',
  `Emp_tel` int(10) NOT NULL COMMENT 'เบอร์โทร',
  `Emp_address` text NOT NULL COMMENT 'ที่อยู่',
  `Emp_moo` int(5) NOT NULL COMMENT 'หมู่',
  `Emp_tumbol` int(11) DEFAULT NULL COMMENT 'ตำบล',
  `Emp_amphur` int(11) DEFAULT NULL COMMENT 'อำเภอ',
  `Emp_road` varchar(45) NOT NULL COMMENT 'ถนน',
  `Emp_province` int(11) DEFAULT NULL COMMENT 'จังหวัด',
  `Emp_zipcode` int(5) NOT NULL COMMENT 'รหัสไปรษณีย์',
  `Emp_mail` varchar(45) NOT NULL COMMENT 'อีเมล์',
  `Emp_start` date NOT NULL COMMENT 'เริ่มทำงาน',
  `Emp_quit` date DEFAULT NULL COMMENT 'ลาออก',
  `Emp_status` enum('ทำงาน','ลาออก') NOT NULL COMMENT 'สถานะ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `manage` (
  `Manage_No` int(11) NOT NULL COMMENT 'รหัสจัดการสินค้า',
  `Manage_date` date DEFAULT NULL COMMENT 'วันที่',
  `PNo` int(11) DEFAULT NULL COMMENT 'รหัสสินค้า',
  `PeoNo` int(11) DEFAULT NULL COMMENT 'ผู้รับผิดชอบ',
  `Manage_Amount` int(11) DEFAULT NULL COMMENT 'จำนวนสินค้า'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(24, '2020-09-21', 8, 1, 3),
(25, '2020-09-21', 9, 1, 3),
(26, '2020-09-21', 10, 1, 3),
(27, '2020-09-21', 11, 1, 3),
(28, '2020-09-21', 12, 1, 3),
(29, '2020-09-21', 13, 1, 3),
(30, '2020-09-21', 14, 1, 2),
(31, '2020-09-21', 15, 1, 2),
(32, '2020-09-21', 16, 1, 3),
(33, '2020-09-21', 17, 1, 2),
(34, '2020-09-21', 18, 1, 3),
(35, '2020-09-21', 19, 1, 3),
(36, '2020-09-21', 20, 1, 3),
(37, '2020-09-21', 21, 1, 3),
(38, '2020-09-21', 22, 1, 2),
(39, '2020-09-21', 23, 1, 3),
(40, '2020-09-21', 24, 1, 3),
(41, '2020-09-21', 25, 1, 3),
(42, '2020-09-21', 26, 1, 4),
(43, '2020-09-21', 27, 1, 4),
(44, '2020-09-21', 28, 1, 4),
(45, '2020-09-21', 29, 1, 4),
(46, '2020-09-21', 30, 1, 4),
(47, '2020-09-21', 31, 1, 7),
(48, '2020-09-24', NULL, 1, 21),
(49, '2020-09-24', 33, 1, 4);
...
CREATE TABLE `product` (
  `PNo` int(11) NOT NULL,
  `Product_no` varchar(11) NOT NULL COMMENT 'รหัสสินค้า',
  `category_id` int(11) DEFAULT NULL COMMENT 'รหัสหมวดหมู่สินค้า',
  `sup_id` int(11) DEFAULT NULL COMMENT 'รหัสบริษัทคู่ค้า',
  `brand_id` int(11) DEFAULT NULL COMMENT 'รหัสยี่ห้อสินค้า',
  `Product_code` varchar(11) DEFAULT NULL COMMENT 'บาร์โค้ด',
  `Product_name` varchar(200) DEFAULT NULL COMMENT 'ชื่อสินค้า',
  `Product_desc` varchar(200) NOT NULL COMMENT 'รายละเอียดสินค้า',
  `Product_price` double(10,2) DEFAULT NULL COMMENT 'ราคาขาย',
  `Product_cost` double(10,2) NOT NULL COMMENT 'ราคาต้นทุน',
...
(1, '010-1', 2, 5, NULL, '1266649479', 'กรอง Hurricane ', 'แบบผ้า', 690.00, 552.00, 13, 'ชิ้น', '2022-06-17', 5),
(2, '010-01', 1, 5, NULL, '7072044490', 'ISUZU ROCKY,TX,JCM', 'มีกุญแจ/940221590', 690.00, 552.00, 22, 'อัน', '2022-06-17', 10),
(3, '010-02', 1, 5, NULL, '9388311416', 'HINO,KT', 'มีกุญแจ/773201010', 695.00, 556.00, 17, 'อัน', '2022-06-17', 10),
(4, '010-03', 1, 5, NULL, '3733372123', 'ISUZU', 'ใหญ่/หนา/777245-444', 199.00, 159.20, 9, 'อัน', '2022-06-17', 5),
(5, '010-04', 1, 5, NULL, '6285277958', 'ISUZU ROCKY', '9-55524-0844', 199.00, 159.20, 22, 'อัน', '2022-06-17', 15),
(6, '010-05', 1, 5, NULL, '9089832490', 'HINO KT/FN527', 'ไม่มีกุญแจ /SAK/77320-1362', 199.00, 159.20, 22, 'อัน', '2022-06-17', 10),
(7, '010-06', 1, 5, NULL, '5082980210', 'ISUZU TFR D-MAX', 'SAK-04858', 295.00, 236.00, 23, 'อัน', '2022-06-17', 15),
(8, '010-07', 1, 5, NULL, '8139604152', 'MITSUBISHI STRADA/SAK', 'SAK-3039', 295.00, 236.00, 23, 'อัน', '2022-06-17', 5),
(9, '010-08', 1, 5, NULL, '5588746664', 'ISUZU D-MAX แคป/SAK', 'SAD-04851', 295.00, 236.00, 23, 'อัน', '2022-06-17', 5),
(10, '010-09', 1, 5, NULL, '7791752736', 'NISSAN BIG-M/NV/SAK', 'SAK-04847', 399.00, 319.20, 23, 'อัน', '2022-06-17', 15),
(11, '010-10', 1, 5, NULL, '6484403514', 'TOYOTA LN40/KE70 ไดน่า/SAK', 'SAK-04873', 199.00, 159.20, 13, 'อัน', '2022-06-17', 10),
(12, '010-11', 1, 5, NULL, '0587726929', 'TOYOTA VIGO TIGER ALTIS /SAK', 'SAK-10239', 199.00, 159.20, 7, 'อัน', '2022-06-17', 10),
(13, '010-12', 1, 5, NULL, '6822109661', 'TOYOTA VIGO ALTIS D4D/SAK', 'SAK-13978', 199.00, 159.20, 13, 'อัน', '2022-06-17', 10),
(14, '010-13', 1, 5, NULL, '3369984658', 'TOYOTA TIGER-MIGHTY-X/SAK', 'SAK-04875', 195.00, 156.00, 11, 'อัน', '2022-06-17', 6),
(15, '010-14', 1, 5, NULL, '4519443017', 'MITSUBISHI L200/FN527/STRADA/SAK', 'SAK-04872', 195.00, 156.00, 12, 'อัน', '2022-06-17', 6),
(16, '010-15', 1, 5, NULL, '5082556086', 'NISSAN SUNNY RN/B11/E13-15/SAK', 'SAK-3058', 195.00, 156.00, 13, 'อัน', '2022-06-17', 8),
(17, '010-16', 1, 5, NULL, '5924840437', 'MITSUBISHI L200/FN527/STRADA/SAK', 'SAK-04872', 195.00, 156.00, 11, 'อัน', '2022-06-17', 8),
(18, '010-17', 1, 5, NULL, '0494688145', 'NISSAN SUNNY RN/B11/E13-15/SAK', 'SAK-3058', 195.00, 156.00, 2, 'อัน', '2022-06-17', 8),
(19, '010-18', 1, 5, NULL, '6050199428', 'NISSAN FRONTIER BDI/SAK', 'SAK-04866', 295.00, 236.00, 3, 'อัน', '2022-06-17', 10),
(20, '010-19', 1, 6, NULL, '2922753293', 'ISUZU 250 KBZ NPR 6BB/SAK', 'SAK-04878', 195.00, 156.00, 3, 'อัน', '2022-06-17', 5),
(21, '010-20', 1, 6, NULL, '2644201473', 'NISSAN TD/SAK', '15255-40F00', 195.00, 156.00, 3, 'ชิ้น', '2022-06-17', 5),
(22, '010-21', 1, 6, NULL, '2546015131', 'ISUZU TFR NPR120 D-MAX/SAK', 'SAK-04880', 195.00, 156.00, 2, 'อัน', '2022-06-17', 5),
(23, '010-22', 1, 6, NULL, '3328360348', 'MITSUBISHI L200 D/SAK', 'SAK-4059', 195.00, 156.00, 3, 'ชิ้น', '2022-06-17', 7),
(24, '010-23', 1, 6, NULL, '6627365919', 'ISUZU NPR NKR BUDDY/SAK', '9-99999-901-0', 195.00, 156.00, 3, 'ชิ้น', '2022-06-17', 7),
(25, '010-24', 1, 6, NULL, '4348532182', 'TOYOTA MIGHTY-X เหล็ก/SAK', 'SAK-7958', 195.00, 156.00, 3, 'ชิ้น', '2022-06-17', 7),
(26, '011-001C2/3', 2, 6, NULL, '9424736926', 'HONDA CR-V2.0,96-01/DENSO', '260300-11204W', 295.00, 236.00, 4, 'ชิ้น', '2022-06-17', 5),
(27, '011-002C2/3', 2, 6, NULL, '8731957466', 'HONDA ACCORD09-11/DENSO', '260300-12304W', 195.00, 156.00, 2, 'อัน', '2022-06-17', 5),
(28, '011-003C2/3', 2, 6, NULL, '5625890406', 'HONDA CR-V2.4 13-17/DENSO', '260300-13304W', 395.00, 316.00, 4, 'ชิ้น', '2022-06-17', 5),
(29, '011-004C2/3', 2, 6, NULL, '3066677335', 'HONDA CR-V2.0 13-17/DENSO', '260300-13404W', 295.00, 236.00, 4, 'ชิ้น', '2022-06-17', 5),
(30, '011-005C1/4', 2, 5, NULL, '7708372083', 'NISSAN TIIDA06-10/DENSO', '260300-02904W', 295.00, 236.00, 4, 'อัน', '2022-06-17', 5),
(31, '011-008C2/3', 2, 5, NULL, '4746782162', 'TOYOTA REVO/DENSO', '260300-09604W', 495.00, 396.00, 7, 'อัน', '2022-06-17', 3),
(33, '011-008C2/3', 2, 5, NULL, '9823596760', 'กรองอากาศ Honda', 'แบบผ้า', 300.00, 240.00, 3, 'อัน', '2022-06-17', 3);
...
CREATE TABLE `purchase` (
  `purchase_id` int(11) NOT NULL COMMENT 'รหัสสั่งซื้อ',
  `PNo` int(11) DEFAULT NULL COMMENT 'รหัสสินค้า',
...
INSERT INTO `purchase` (`purchase_id`, `PNo`, `quantity`, `bill_id`) VALUES
(22, 1, 1, 4),
(23, 3, 1, 4);
...
INSERT INTO `purchase_bill` (`id`, `date`, `sup_id`) VALUES
(4, '2021-02-10', 5);
...
CREATE TABLE `supplier` (
  `sup_id` int(11) NOT NULL COMMENT 'รหัสบริษัทคู่ค้า',
  `sup_company` varchar(100) NOT NULL COMMENT 'ชื่อบริษัทคู่ค้า',
  `sup_username` varchar(50) NOT NULL COMMENT 'ชื่อผู้ติดต่อ',
  `sup_address` varchar(200) NOT NULL COMMENT 'ที่อยู่',
  `sup_moo` int(11) NOT NULL COMMENT 'หมู่',
  `sup_tumbol` int(11) DEFAULT NULL COMMENT 'ตำบล',
  `sup_amphur` int(11) DEFAULT NULL COMMENT 'อำเภอ',
  `sup_province` int(11) DEFAULT NULL COMMENT 'จังหวัด',
  `sup_zipcode` int(5) NOT NULL COMMENT 'รหัสไปรษณีย์',
  `sup_tel` varchar(15) NOT NULL COMMENT 'เบอร์ติดต่อ',
  `sup_detail` varchar(100) NOT NULL COMMENT 'รายละเอียด'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `supplier` (`sup_id`, `sup_company`, `sup_username`, `sup_address`, `sup_moo`, `sup_tumbol`, `sup_amphur`, `sup_province`, `sup_zipcode`, `sup_tel`, `sup_detail`) VALUES
(5, 'ออโต้มาร์ท ', 'ชาญวิศ ประสานเหลืองวิไล', 'บ้านเลขที่  หมู่ 11 คลองหนึ่ง คลองหลวง ปทุมธานี 12120', 11, 130201, 67, 4, 12120, '020870077', 'อะไหล่รถยนต์และเครื่องมือช่างทุกประเภท'),
(6, 'วรอินเตอร์ อะไหล่ยนต์', 'ส.วรกมล', '123', 16, 301801, 232, 19, 30170, '0883472150', 'จำหน่ายอะไหล่รถยนต์ ปลีก-ส่ง');
...
CREATE TABLE `user` (
  ...
  `nickname` varchar(50) NOT NULL COMMENT 'ชื่อ',
  `password_hash` varchar(100) NOT NULL COMMENT 'รหัสผ่าน',
  `email` varchar(100) CHARACTER SET utf16 DEFAULT NULL COMMENT 'อีเมล์',
  `auth_key` varchar(255) DEFAULT NULL COMMENT 'คีย์',
  `roles` int(255) DEFAULT NULL COMMENT 'บทบาท',
  `password_reset_token` varchar(255) DEFAULT NULL COMMENT 'โทเค่นตั้งรหัสผ่านใหม่',
...
INSERT INTO `user` (`userNo`, `username`, `nickname`, `password_hash`, `email`, `auth_key`, `roles`, `password_reset_token`, `status`) VALUES
(1, 'admin', 'ADMIN', '$2y$10$y/a8RSlQAjeZPDs/wfMeyuK/5CpJp6loJ964XG4i0uxqnTqc8zDA.', 'kukik_2541@hotmail.com', '', 30, '5aTqjplrACIGx0zqLtrbAFbiAusA3IaD_1602314207', 0),
...
ALTER TABLE `employee`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `Emp_province` (`Emp_province`),
  ADD KEY `Emp_tumbol` (`Emp_tumbol`),
  ADD KEY `Emp_amphur` (`Emp_amphur`);
...
ALTER TABLE `product`
  ADD PRIMARY KEY (`PNo`),
  ADD KEY `R_4` (`category_id`),
  ADD KEY `product_ibfk_1` (`sup_id`);
...
--
ALTER TABLE `bill`
  MODIFY `BillNo` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสใบเสร็จ', AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `bill_detail`
--
ALTER TABLE `bill_detail`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดี', AUTO_INCREMENT=49;
...
--
ALTER TABLE `category`
  MODIFY `category_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสหมวดหมู่สินค้า', AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `employee`
--
ALTER TABLE `employee`
  MODIFY `ID` int(10) NOT NULL AUTO_INCREMENT COMMENT 'คีย์', AUTO_INCREMENT=4;
...
--
ALTER TABLE `manage`
  MODIFY `Manage_No` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสจัดการสินค้า', AUTO_INCREMENT=50;
...
--
ALTER TABLE `purchase`
  MODIFY `purchase_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสสั่งซื้อ', AUTO_INCREMENT=24;
...
--
ALTER TABLE `supplier`
  MODIFY `sup_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสบริษัทคู่ค้า', AUTO_INCREMENT=7;
...
--
ALTER TABLE `bill`
  ADD CONSTRAINT `R_10` FOREIGN KEY (`PeoNo`) REFERENCES `user` (`userNo`) ON DELETE SET NULL;

--
-- Constraints for table `bill_detail`
--
ALTER TABLE `bill_detail`
  ADD CONSTRAINT `bill_detail_ibfk_1` FOREIGN KEY (`pno`) REFERENCES `product` (`PNo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `bill_detail_ibfk_2` FOREIGN KEY (`bill_id`) REFERENCES `bill` (`BillNo`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `cart`
  ADD CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`userNo`) REFERENCES `user` (`userNo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`PNo`) REFERENCES `product` (`PNo`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `employee`
--
ALTER TABLE `employee`
  ADD CONSTRAINT `employee_ibfk_1` FOREIGN KEY (`Emp_province`) REFERENCES `provinces` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `employee_ibfk_2` FOREIGN KEY (`Emp_tumbol`) REFERENCES `districts` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `employee_ibfk_3` FOREIGN KEY (`Emp_amphur`) REFERENCES `amphures` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `manage`
--
ALTER TABLE `manage`
  ADD CONSTRAINT `R_6` FOREIGN KEY (`PNo`) REFERENCES `product` (`PNo`) ON DELETE SET NULL,
  ADD CONSTRAINT `R_9` FOREIGN KEY (`PeoNo`) REFERENCES `user` (`userNo`) ON DELETE SET NULL;

--
-- Constraints for table `product`
--
ALTER TABLE `product`
  ADD CONSTRAINT `R_4` FOREIGN KEY (`category_id`) REFERENCES `category` (`category_id`) ON DELETE SET NULL,
  ADD CONSTRAINT `product_ibfk_1` FOREIGN KEY (`sup_id`) REFERENCES `supplier` (`sup_id`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `purchase`
--
ALTER TABLE `purchase`
  ADD CONSTRAINT `purchase_ibfk_1` FOREIGN KEY (`PNo`) REFERENCES `product` (`PNo`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `purchase_ibfk_2` FOREIGN KEY (`bill_id`) REFERENCES `purchase_bill` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `purchase_bill`
--
ALTER TABLE `purchase_bill`
  ADD CONSTRAINT `purchase_bill_ibfk_1` FOREIGN KEY (`sup_id`) REFERENCES `supplier` (`sup_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
