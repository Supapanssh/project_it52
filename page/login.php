                    ...
                    <div class="panel-body">
                        <form method="post">
                            ...
                            <div class="form-group">
                                <input class="form-control" placeholder="ชื่อผู้ใช้" name="user" type="text" autofocus autocomplete="off">
                            </div>
                            <div class="form-group">
                                <input class="form-control" placeholder="รหัสผ่าน" name="pass" type="password" value="">
                            </div>
                            <u>
                                <div class="form-group">
                                    <a href="lostpass.php">ลืมรหัสผ่าน
                            </u>
                    </div>
