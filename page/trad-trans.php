...
$sql = "SELECT BillNo,BillDate,Bill_detail,BillDiscount,BillTotal,BillCash,nickname FROM `bill` LEFT JOIN user ON bill.PeoNo=user.userNo $cond ORDER BY BillNo ASC";
//echo $sql;
#excute statement
