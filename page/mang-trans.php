...
$sql = "SELECT Manage_No,Manage_Date,Product_name,Manage_Amount,nickname FROM `product_manage` LEFT JOIN product  ON product_manage.PNo=product.PNo  LEFT JOIN user  ON product_manage.PeoNo=user.userNo $cond ORDER BY Manage_No ASC";
//echo $sql;
#excute statement
