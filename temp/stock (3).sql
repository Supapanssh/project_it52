...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 24, 2021 at 05:18 PM
...
(22, '2021-01-20', 1, NULL, 0, '3787.80', '3787.80', '247.80', 0),
(23, '2021-01-24', 1, NULL, 0, '3284.90', '3284.90', '214.90', 0);
...
(1, '010-1', 2, NULL, '1266649479', 'กรอง Hurricane ', 'แบบผ้า', 690.00, 650.00, 17, 'ชิ้น', '2022-06-17', 5),
(2, '010-01', 1, NULL, '7072044490', 'ISUZU ROCKY,TX,JCM', 'มีกุญแจ/940221590', 690.00, 0.00, 22, 'อัน', '2022-06-17', 10),
(3, '010-02', 1, NULL, '9388311416', 'HINO,KT', 'มีกุญแจ/773201010', 695.00, 0.00, 17, 'อัน', '2022-06-17', 10),
(4, '010-03', 1, NULL, '3733372123', 'ISUZU', 'ใหญ่/หนา/777245-444', 199.00, 0.00, 10, 'อัน', '2022-06-17', 5),
(5, '010-04', 1, NULL, '6285277958', 'ISUZU ROCKY', '9-55524-0844', 199.00, 0.00, 22, 'อัน', '2022-06-17', 15),
(6, '010-05', 1, NULL, '9089832490', 'HINO KT/FN527', 'ไม่มีกุญแจ /SAK/77320-1362', 199.00, 0.00, 22, 'อัน', '2022-06-17', 10),
(7, '010-06', 1, NULL, '5082980210', 'ISUZU TFR D-MAX', 'SAK-04858', 295.00, 0.00, 23, 'อัน', '2022-06-17', 15),
(8, '010-07', 1, NULL, '8139604152', 'MITSUBISHI STRADA/SAK', 'SAK-3039', 295.00, 0.00, 23, 'อัน', '2022-06-17', 5),
...
(12, '010-11', 1, NULL, '0587726929', 'TOYOTA VIGO TIGER ALTIS /SAK', 'SAK-10239', 199.00, 0.00, 7, 'อัน', '2022-06-17', 10),
(13, '010-12', 1, NULL, '6822109661', 'TOYOTA VIGO ALTIS D4D/SAK', 'SAK-13978', 199.00, 0.00, 13, 'อัน', '2022-06-17', 10),
(14, '010-13', 1, NULL, '3369984658', 'TOYOTA TIGER-MIGHTY-X/SAK', 'SAK-04875', 195.00, 0.00, 11, 'อัน', '2022-06-17', 6),
...
(17, '010-16', 1, NULL, '5924840437', 'MITSUBISHI L200/FN527/STRADA/SAK', 'SAK-04872', 195.00, 0.00, 11, 'อัน', '2022-06-17', 8),
(18, '010-17', 1, NULL, '0494688145', 'NISSAN SUNNY RN/B11/E13-15/SAK', 'SAK-3058', 195.00, 0.00, 2, 'อัน', '2022-06-17', 8),
...
(22, '010-21', 1, NULL, '2546015131', 'ISUZU TFR NPR120 D-MAX/SAK', 'SAK-04880', 195.00, 0.00, 2, 'อัน', '2022-06-17', 5),
(23, '010-22', 1, NULL, '3328360348', 'MITSUBISHI L200 D/SAK', 'SAK-4059', 195.00, 0.00, 3, 'ชิ้น', '2022-06-17', 7),
...
(31, '011-008C2/3', 2, NULL, '4746782162', 'TOYOTA REVO/DENSO', '260300-09604W', 495.00, 0.00, 7, 'อัน', '2022-06-17', 3),
(33, '011-008C2/3', 2, NULL, '9823596760', 'กรองอากาศ Honda', 'แบบผ้า', 300.00, 0.00, 3, 'อัน', '2022-06-17', 3);
...
CREATE TABLE `sell` (
  `SellNo` int(11) NOT NULL COMMENT 'รหัสรายการขาย',
  `PNo` int(11) DEFAULT NULL COMMENT 'ผู้รับผิดชอบ',
  `BillNo` int(11) DEFAULT NULL COMMENT 'รหัสใบเสร็จ',
  `SellAmount` int(11) DEFAULT NULL COMMENT 'จำนวนที่ขาย'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `supplier` (
  `sup_id` int(4) NOT NULL COMMENT 'รหัสบริษัทคู่ค้า',
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `sumary_bill`  AS  select `product`.`Product_name` AS `Product_name`,`category`.`category_name` AS `category_name`,`bill_detail`.`quantity` AS `quantity`,`bill_detail`.`amount` AS `amount`,`bill`.`BillDate` AS `BillDate` from (((`product` join `bill_detail` on((`bill_detail`.`pno` = `product`.`PNo`))) join `category` on((`product`.`category_id` = `category`.`category_id`))) join `bill` on((`bill_detail`.`bill_id` = `bill`.`BillNo`))) ;
...
--
ALTER TABLE `sell`
  ADD PRIMARY KEY (`SellNo`) USING BTREE,
  ADD KEY `R_12` (`PNo`),
  ADD KEY `R_16` (`BillNo`);
...
--
ALTER TABLE `bill`
  MODIFY `BillNo` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสใบเสร็จ', AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `bill_detail`
--
ALTER TABLE `bill_detail`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดี', AUTO_INCREMENT=45;
...
--
ALTER TABLE `cart`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีตะกร้าสินค้า', AUTO_INCREMENT=12;
...
--
ALTER TABLE `supplier`
  MODIFY `sup_id` int(4) NOT NULL AUTO_INCREMENT COMMENT 'รหัสบริษัทคู่ค้า', AUTO_INCREMENT=6;
...
--
ALTER TABLE `sell`
  ADD CONSTRAINT `sell_ibfk_1` FOREIGN KEY (`PNo`) REFERENCES `product` (`PNo`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `sell_ibfk_2` FOREIGN KEY (`BillNo`) REFERENCES `bill` (`BillNo`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
