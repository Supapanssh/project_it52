...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 10, 2020 at 08:08 AM
...
CREATE TABLE `bill` (
  ...
  `PeoNo` int(11) DEFAULT NULL,
  `Bill_detail` varchar(100) DEFAULT NULL,
  `BillDiscount` int(11) NOT NULL DEFAULT '0',
  `BillTotal` int(11) NOT NULL,
  `BillCash` int(11) NOT NULL,
  `Billvat` decimal(10,2) NOT NULL
...
(1, '2020-09-24', 1, 'Test Bill', 0, 885, 946, '0.00'),
(2, '2020-09-24', 1, 'Test bill', 2, 394, 418, '27.58'),
(6, '2020-09-24', 1, '', 0, 390, 417, '27.30');
...
CREATE TABLE `employee` (
  ...
  `Emp_moo` int(5) NOT NULL,
  `Emp_tumbol` int(11) DEFAULT NULL,
  `Emp_amphur` int(11) DEFAULT NULL,
  `Emp_road` varchar(45) NOT NULL,
  `Emp_province` int(11) DEFAULT NULL,
  `Emp_zipcode` int(5) NOT NULL,
  `Emp_mail` varchar(45) NOT NULL,
  `Emp_start` date NOT NULL,
  `Emp_quit` date NOT NULL,
  `Emp_status` enum('ทำงาน','ลาออก') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(2, 'Emp02', 1307483647, 'นายศุภกร', 'เอมชนานนท์', 'ชาย', '1997-09-15', 961827437, 'บ้านเลขที่ 89/3 หมู่ 1 บางเสด็จ ป่าโมก อ่างทอง 14130', 1, 150305, 92, '', 6, 14130, 'Pond_em@gmail.com', '2020-09-02', '0000-00-00', 'ทำงาน'),
(3, 'Emp03', 2147483647, 'วิไล', 'งามวงษ์', 'หญิง', '1980-09-15', 930423444, 'บ้านเลขที่ 11 หมู่ 4 หน้าไม้ บางไทร พระนครศรีอยุธยา 13190', 4, 140405, 77, '', 5, 13190, 'vili@gmail.com', '2020-09-23', '0000-00-00', 'ทำงาน');
...
INSERT INTO `product` (`PNo`, `Product_no`, `category_id`, `brand_id`, `Product_code`, `Product_name`, `Product_desc`, `Product_price`, `Product_cost`, `Product_quantity`, `Product_unit`, `Product_exp`) VALUES
(1, '010-1', 2, NULL, '1266649479', 'กรอง Hurricane ', 'แบบผ้า', 690.00, 650.00, 21, 'ชิ้น', '0000-00-00'),
(2, '010-01', 1, NULL, '7072044490', 'ISUZU ROCKY,TX,JCM', 'มีกุญแจ/940221590', 690.00, 0.00, 2, 'อัน', '0000-00-00'),
(3, '010-02', 1, NULL, '9388311416', 'HINO,KT', 'มีกุญแจ/773201010', 695.00, 0.00, 3, 'อัน', '0000-00-00'),
(4, '010-03', 1, NULL, '3733372123', 'ISUZU', 'ใหญ่/หนา/777245-444', 199.00, 0.00, 2, 'อัน', '0000-00-00'),
(5, '010-04', 1, NULL, '6285277958', 'ISUZU ROCKY', '9-55524-0844', 199.00, 0.00, 2, 'อัน', '0000-00-00'),
(6, '010-05', 1, NULL, '9089832490', 'HINO KT/FN527', 'ไม่มีกุญแจ /SAK/77320-1362', 199.00, 0.00, 2, 'อัน', '0000-00-00'),
(7, '010-06', 1, NULL, '5082980210', 'ISUZU TFR D-MAX', 'SAK-04858', 295.00, 0.00, 3, 'อัน', '0000-00-00'),
(8, '010-07', 1, NULL, '8139604152', 'MITSUBISHI STRADA/SAK', 'SAK-3039', 295.00, 0.00, 3, 'อัน', '0000-00-00'),
(9, '010-08', 1, NULL, '5588746664', 'ISUZU D-MAX แคป/SAK', 'SAD-04851', 295.00, 0.00, 3, 'อัน', '0000-00-00'),
(10, '010-09', 1, NULL, '7791752736', 'NISSAN BIG-M/NV/SAK', 'SAK-04847', 399.00, 0.00, 3, 'อัน', '0000-00-00'),
(11, '010-10', 1, NULL, '6484403514', 'TOYOTA LN40/KE70 ไดน่า/SAK', 'SAK-04873', 199.00, 0.00, 3, 'อัน', '0000-00-00'),
(12, '010-11', 1, NULL, '0587726929', 'TOYOTA VIGO TIGER ALTIS /SAK', 'SAK-10239', 199.00, 0.00, 3, 'อัน', '0000-00-00'),
(13, '010-12', 1, NULL, '6822109661', 'TOYOTA VIGO ALTIS D4D/SAK', 'SAK-13978', 199.00, 0.00, 3, 'อัน', '0000-00-00'),
(14, '010-13', 1, NULL, '3369984658', 'TOYOTA TIGER-MIGHTY-X/SAK', 'SAK-04875', 195.00, 0.00, 2, 'อัน', '0000-00-00'),
(15, '010-14', 1, NULL, '4519443017', 'MITSUBISHI L200/FN527/STRADA/SAK', 'SAK-04872', 195.00, 0.00, 2, 'อัน', '0000-00-00'),
(16, '010-15', 1, NULL, '5082556086', 'NISSAN SUNNY RN/B11/E13-15/SAK', 'SAK-3058', 195.00, 0.00, 3, 'อัน', '0000-00-00'),
(17, '010-16', 1, NULL, '5924840437', 'MITSUBISHI L200/FN527/STRADA/SAK', 'SAK-04872', 195.00, 0.00, 2, 'อัน', '0000-00-00'),
(18, '010-17', 1, NULL, '0494688145', 'NISSAN SUNNY RN/B11/E13-15/SAK', 'SAK-3058', 195.00, 0.00, 2, 'อัน', '0000-00-00'),
(19, '010-18', 1, NULL, '6050199428', 'NISSAN FRONTIER BDI/SAK', 'SAK-04866', 295.00, 0.00, 3, 'อัน', '0000-00-00'),
(20, '010-19', 1, NULL, '2922753293', 'ISUZU 250 KBZ NPR 6BB/SAK', 'SAK-04878', 195.00, 0.00, 3, 'อัน', '0000-00-00'),
(21, '010-20', 1, NULL, '2644201473', 'NISSAN TD/SAK', '15255-40F00', 195.00, 0.00, 3, 'ชิ้น', '0000-00-00'),
(22, '010-21', 1, NULL, '2546015131', 'ISUZU TFR NPR120 D-MAX/SAK', 'SAK-04880', 195.00, 0.00, 2, 'อัน', '0000-00-00'),
(23, '010-22', 1, NULL, '3328360348', 'MITSUBISHI L200 D/SAK', 'SAK-4059', 195.00, 0.00, 3, 'ชิ้น', '0000-00-00'),
(24, '010-23', 1, NULL, '6627365919', 'ISUZU NPR NKR BUDDY/SAK', '9-99999-901-0', 195.00, 0.00, 3, 'ชิ้น', '0000-00-00'),
(25, '010-24', 1, NULL, '4348532182', 'TOYOTA MIGHTY-X เหล็ก/SAK', 'SAK-7958', 195.00, 0.00, 3, 'ชิ้น', '0000-00-00'),
(26, '011-001C2/3', 2, NULL, '9424736926', 'HONDA CR-V2.0,96-01/DENSO', '260300-11204W', 295.00, 0.00, 4, 'ชิ้น', '0000-00-00'),
(27, '011-002C2/3', 2, NULL, '2487520828', 'HONDA ACCORD09-11/DENSO', '260300-12304W', 195.00, 0.00, 4, 'อัน', '0000-00-00'),
(28, '011-003C2/3', 2, NULL, '5625890406', 'HONDA CR-V2.4 13-17/DENSO', '260300-13304W', 395.00, 0.00, 4, 'ชิ้น', '0000-00-00'),
(29, '011-004C2/3', 2, NULL, '3066677335', 'HONDA CR-V2.0 13-17/DENSO', '260300-13404W', 295.00, 0.00, 4, 'ชิ้น', '0000-00-00'),
(30, '011-005C1/4', 2, NULL, '7708372083', 'NISSAN TIIDA06-10/DENSO', '260300-02904W', 295.00, 0.00, 4, 'อัน', '0000-00-00'),
(31, '011-008C2/3', 2, NULL, '4746782162', 'TOYOTA REVO/DENSO', '260300-09604W', 495.00, 0.00, 7, 'อัน', '0000-00-00'),
(33, '', 2, NULL, '9823596760', 'กรองอากาศ Honda', 'แบบผ้า', 300.00, 0.00, 4, 'อัน', '0000-00-00');
...
CREATE TABLE `product_manage` (
  ...
  `PeoNo` int(11) DEFAULT NULL,
  `Manage_Amount` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `product_manage`
--

INSERT INTO `product_manage` (`Manage_No`, `Manage_date`, `PNo`, `PeoNo`, `Manage_Amount`) VALUES
(18, '2020-09-21', 2, 1, 2),
(19, '2020-09-21', 3, 1, 3),
(20, '2020-09-21', 4, 1, 2),
(21, '2020-09-21', 5, 1, 2),
...
INSERT INTO `sell` (`SellNo`, `PNo`, `BillNo`, `SellAmount`) VALUES
(1, 18, 1, 1),
(2, 1, 1, 1);
...
CREATE TABLE `supplier` (
  ...
  `sup_moo` int(11) NOT NULL,
  `sup_tumbol` int(11) DEFAULT NULL,
  `sup_amphur` int(11) DEFAULT NULL,
  `sup_province` int(11) DEFAULT NULL,
  `sup_zipcode` int(5) NOT NULL,
  `sup_tel` varchar(15) NOT NULL,
  `sup_detail` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 'บริษัทขอนแก่นมิตรยนต์จำกัด', 'วรเทพ', 'ถนนหน้าเมือง ขอนแก่น', 0, 0, 0, 0, 0, '0442534471', 'ผู้จำหน่ายชิ้นส่วนรถยนต์'),
(2, 'บริษัทมอเตอร์อะไหล่รถ', 'ชัยชนะ', 'กรุงเทพ', 0, 0, 0, 0, 0, '0977434555', 'อะไหล่รถยนต์ทุกชนิด'),
...
CREATE TABLE `user` (
  ...
  `user_email` varchar(100) CHARACTER SET utf16 DEFAULT NULL,
...
INSERT INTO `user` (`userNo`, `username`, `nickname`, `password`, `user_email`, `status`) VALUES
(1, 'admin', 'ADMIN', 'admin', 'kukik_25@hotmail.com', 'ADMIN'),
(2, 'user', 'shinee', '1234', 'use_1@hotmail.com', 'USER'),
(3, 'Sean ', 'Kings', 'sean', 'sean.k@gmail.com', 'MANAGER'),
(4, 'bolb', 'ball', 'bolb4', 'ball_ba@gmail.com', 'CASHIER');
...
--
ALTER TABLE `bill`
  MODIFY `BillNo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `product_manage`
  MODIFY `Manage_No` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `sell`
  MODIFY `SellNo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `supplier`
--
ALTER TABLE `supplier`
  MODIFY `sup_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- Constraints for table `product_manage`
--
ALTER TABLE `product_manage`
...
--
ALTER TABLE `sell`
  ADD CONSTRAINT `R_12` FOREIGN KEY (`PNo`) REFERENCES `product` (`PNo`) ON DELETE SET NULL,
  ADD CONSTRAINT `R_16` FOREIGN KEY (`BillNo`) REFERENCES `bill` (`BillNo`);
COMMIT;
